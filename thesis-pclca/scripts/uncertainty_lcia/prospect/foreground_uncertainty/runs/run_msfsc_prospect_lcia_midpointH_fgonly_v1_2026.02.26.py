# -*- coding: utf-8 -*-
"""
run_msfsc_prospect_lcia_midpointH_fgonly_v1_2026.02.26.py
...
Usage:
  python run_msfsc_prospect_lcia_midpointH_fgonly_v1_2026.02.26.py ^
...
def run_monte_carlo(
    *,
    ...
    for sid, h in handles_by_sid.items():
        # detect FU conversion once (scrap -> billet)
        ...
        for it in range(1, iterations + 1):
            ...
            # build per-iter demands (note staged_total/joint are scaled by pass_share)
...
def main():
    ...
    logger = setup_logger("run_msfsc_prospect_lcia_midpointH_fgonly_v1")
    ...
    logger.info("[done] Prospective MSFSC FG-only/joint/bg-only uncertainty LCIA run complete (v1).")
