...
TPL_LANDFILL = "treatment of aluminium scrap, post-consumer, sanitary landfill"
...
def main():
    ...
    if not args.apply:
        ...
        for sid, bg_db in scenarios:
            ...
            lan_tpl = pick_activity(bg_db, TPL_LANDFILL, template_loc_pref, logger=logger, kind="pick-tpl")
    ...
    for sid, bg_db in scenarios:
        ...
        elec_proc_mv = pick_activity(bg_db, "market for electricity, medium voltage",
                                     electricity_loc_preference("NA"), logger=logger, kind="pick-elec-proc")
        elec_proc_lv = pick_activity(bg_db, "market for electricity, low voltage",
                                     electricity_loc_preference("NA"), logger=logger, kind="pick-elec-proc")
        elec_credit_mv = pick_activity(bg_db, "market for electricity, medium voltage",
                                       electricity_loc_preference("CA"), logger=logger, kind="pick-elec-credit")
        ...
        rw_landfill = make_or_clear(args.fg_db, rw_landfill_code, f"Route wrapper C3–C4: landfill [CA; {sid}]",
                                    location="CA", unit="kilogram", ref_product="route wrapper service", overwrite=True, logger=logger)
        ...
        rw_reuse_c3 = make_or_clear(args.fg_db, rw_reuse_c3_code, f"Route wrapper C3: reuse prep (degrease scaled) [CA; {sid}]",
                                    location="CA", unit="kilogram", ref_product="route wrapper service", overwrite=True, logger=logger)
        ...
        rw_recycling_c3c4 = make_or_clear(args.fg_db, rw_recycling_c3c4_code,
        ...
        rw_landfill_net = make_or_clear(args.fg_db, rw_landfill_net_code, f"Route wrapper NET: landfill [CA; {sid}]",
                                        location="CA", unit="kilogram", ref_product="net route wrapper service", overwrite=True, logger=logger)
        ...
        rw_reuse_net = make_or_clear(args.fg_db, rw_reuse_net_code, f"Route wrapper NET: reuse (C3 + Stage D) [CA; {sid}]",
                                     location="CA", unit="kilogram", ref_product="net route wrapper service", overwrite=True, logger=logger)
        ...
        rw_recycling_net = make_or_clear(args.fg_db, rw_recycling_net_code, f"Route wrapper NET: recycling post-consumer [CA; {sid}]",
                                         location="CA", unit="kilogram", ref_product="net route wrapper service", overwrite=True, logger=logger)
