...
- Top contributing technosphere activities under GWP1000 (absolute characterized contribution)
...
def main():
    ...
    # 1) GWP-only run with detailed contributors (your original behaviour)
    ...
    if WRITE_REPORT:
        ...
        json_path = REPORT_DIR / f"det_lca_hydrolysis_c3c4_stageD_joint_{tag}.json"
        payload = {
        ...
        if all_impacts_rows:
            impacts_csv_path = REPORT_DIR / f"det_lca_hydrolysis_c3c4_stageD_all_impacts_{tag}.csv"
            fieldnames = [
                "method_0",
                "method_1",
                "method_2",
        ...
        if top_rows:
            contrib_csv_path = REPORT_DIR / f"det_lca_hydrolysis_c3c4_stageD_topGWP_{tag}.csv"
            fieldnames = [
                "module",
                "rank",
                "db",
