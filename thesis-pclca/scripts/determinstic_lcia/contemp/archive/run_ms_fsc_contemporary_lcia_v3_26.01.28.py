# run_msfsc_c3c4_stageD_ipcc_summary_contemp_v1_26.01.28.py
...
def setup_logger(root: Path) -> logging.Logger:
    ...
    log_path = logs_dir / f"run_msfsc_ipcc_summary_contemp_{ts}.txt"

    logger = logging.getLogger("run_msfsc_ipcc_summary_contemp")
