# -*- coding: utf-8 -*-
"""
run_al_base_routes_contemp_lcia_midpointH_v7.3_26.02.11.py

LCIA runner for contemporary aluminium base route wrappers.
...
def main() -> None:
    ...
    ap.add_argument("--project", default=os.environ.get("BW_PROJECT", "pCLCA_CA_2025_contemp"))
    ap.add_argument("--fg-db", default=os.environ.get("BW_FG_DB", "mtcw_foreground_contemporary"))
    ...
    logger = setup_logger(Path(args.log_dir), stem="run_al_base_routes_contemp_lcia_midpointH_v11")
    ...
    ts = dt.datetime.now().strftime("%Y%m%d-%H%M%S")
    out_csv = out_dir / f"al_base_routes_contemp_lcia_midpointH_v11_{ts}.csv"
